...
import TopButton from '@/components/TopButton';               // ★ 追加
    ...
    <>
      <div className="w-full home-page">
              ...
              <h1 className="text-responsive-4xl sm:text-responsive-5xl font-sans font-bold mb-4 sm:mb-6 lg:mb-8 text-gray-700 japanese-text leading-tight break-words">
                ...
                <p
                  className="
                    not-prose
                    mb-3 sm:mb-4
                    japanese-text text-gray-700
                    leading-relaxed text-center break-words sm:whitespace-nowrap
                    !text-[clamp(1rem,3vw,2rem)]   /* ← 約10〜15%アップ */
                    md:!text-[clamp(1rem,3vw,1.5rem)]
                    lg:!text-[clamp(1rem,3vw,1.5rem)]
                  "
                >– 衣服が社会を映す「鏡」だとしたら、わたしたちの服装から何が映って見えるのか –</p>
        ...
        <section id="intro" className="min-h-screen flex flex-col justify-center mb-12 sm:mb-16 lg:mb-24 px-4 sm:px-6 lg:px-8 w-full mx-auto relative container-responsive">
          ...
          <div className="text-center mb-8 mt-12 sm:mt-16 lg:mt-20">
            <div className="inline-block relative">
              <div className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-light tracking-wide mb-2 text-gray-800 japanese-text sm:whitespace-nowrap">
                はじめに
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center w-full">
            <div className="prose prose-lg max-w-4xl w-full mx-auto">
              <div className="space-y-6 sm:space-y-8 lg:space-y-10 text-gray-700 leading-loose japanese-text">
                ...
                <p
                  className="
                    not-prose               /* ← proseの上書きを無効化 */
                    font-bold text-gray-700
                    mb-6 sm:mb-8 text-center japanese-text break-words sm:whitespace-nowrap
                    !text-[clamp(1rem,3.25vw,1.5rem)]   /* ← 必ず効く特大サイズ（重要: 先頭の !） */
                    leading-[1.2]                     /* 行間を少し詰める */
                  "
                >
                ...
                <div className="mt-8 sm:mt-10 lg:mt-12 space-y-4 sm:space-y-5 lg:space-y-6 text-responsive-base sm:text-responsive-lg leading-loose">
                  <p className="text-left mb-2 break-words sm:whitespace-nowrap">本来なら捨てられるはずだった一着の着物を前に、「この着物を、もっと生かす方法はないだろうか」。</p>

                  <p className="text-left mb-2 break-words sm:whitespace-nowrap">
                  ...
                  <p className="text-left  mb-2 pb-4 sm:pb-6 break-words sm:whitespace-nowrap">
                  ...
                  <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 relative pb-4 sm:pb-6">
                    <p className="text-left text-responsive-base sm:text-responsive-lg leading-loose text-gray-600 mb-6 sm:mb-8 japanese-text break-words sm:whitespace-nowrap">
                    会場での出会いや対話を通じて、「まとうこと」の意味や広がりを、未来に向けて感じ取ってもらえたら嬉しいです。
                    </p>
                    <p className="text-right text-responsive-base sm:text-responsive-lg leading-loose text-gray-600 mb-6 sm:mb-8 japanese-text break-words sm:whitespace-nowrap">
                    企画者　鈴木 祐太
                    </p>
                  </div>
                </div>
        ...
        <section id="chapters" className="w-full">
          {/* 各章の紹介見出しを追加 */}
          <div className="bg-gray-10 py-1　mb-1 sm:mb-1 lg:mb-1">
                              ...
                              <Link href="/artists/imai-saki" className="group block">
                                <div className="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 bg-white transform">
                                  ...
                                  <div className="h-[300px] md:h-[400px] lg:h-[500px] relative overflow-hidden">
                                    <Image 
                                      src="https://res.cloudinary.com/dfsg7aahv/image/upload/v1755248097/c2a143a8-433a-40b1-8d59-ea1fe6ed8e48_ngkywv_etd91h.webp"
                                      alt="路上書房の設営風景"
                                      fill
                                  ...
                                  <div className="absolute bottom-0 left-0 right-0 p-4">
                                    ...
                                    <div className="relative flex items-end space-x-4">
                                      ...
                                      <div className="w-24 h-24 rounded-xl overflow-hidden border-2 border-white/80 shadow-lg backdrop-blur-sm flex-shrink-0 mb-1">
                                        <img 
                                          src="https://res.cloudinary.com/dfsg7aahv/image/upload/v1755248139/%E4%BB%8A%E4%BA%95%E3%81%95%E3%82%93_vfifeg_brt3gu.webp"
                                          alt="今井 咲希"
